...
evaluationIndFIM_admin1 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
...
evaluationIndFIM_admin2 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
                                      modelEquations = modelEquations,
                                      modelParameters = modelParameters,
                                      modelError =  modelError,
                                      designs = list( design1 ),
...
evaluationIndFIM_admin3 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
                                      modelEquations = modelEquations,
                                      modelParameters = modelParameters,
                                      modelError =  modelError,
                                      designs = list( design1 ),
...
evaluationIndFIM_admin4 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
                                      modelEquations = modelEquations,
                                      modelParameters = modelParameters,
                                      modelError =  modelError,
                                      designs = list( design1 ),
...
evaluationIndFIM_admin4 = run( evaluationIndFIM_admin4 )
...
evaluationIndFIM_admin5 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
                                      modelEquations = modelEquations,
                                      modelParameters = modelParameters,
                                      modelError =  modelError,
                                      designs = list( design1 ),
...
evaluationIndFIM_admin5 = run( evaluationIndFIM_admin5 )
...
evaluationIndFIM_admin6 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
                                      modelEquations = modelEquations,
                                      modelParameters = modelParameters,
                                      modelError =  modelError,
                                      designs = list( design1 ),
...
evaluationIndFIM_admin6 = run( evaluationIndFIM_admin6 )
...
outputFile = "indFIM_admin4.html"
outputFileRDS = "popFIM_admin4.rds"
saveRDS(evaluationIndFIM_admin4, file = file.path(outputPath, outputFileRDS))
Report( evaluationIndFIM_admin4, outputPath, outputFile, plotOptions )

outputFile = "indFIM_admin5.html"
outputFileRDS = "popFIM_admin5.rds"
saveRDS(evaluationIndFIM_admin5, file = file.path(outputPath, outputFileRDS))
Report( evaluationIndFIM_admin5, outputPath, outputFile, plotOptions )

outputFile = "indFIM_admin6.html"
outputFileRDS = "popFIM_admin6.rds"
saveRDS(evaluationIndFIM_admin6, file = file.path(outputPath, outputFileRDS))
Report( evaluationIndFIM_admin6, outputPath, outputFile, plotOptions )
