...
modelParameters = list(
  ...
  ModelParameter( name = "Emax", distribution = LogNormal( mu = 10,  omega = 0.5 ) ),
  ModelParameter( name = "Rin", distribution = LogNormal( mu = 5,  omega = 0.1 ) ),
  ModelParameter( name = "kout", distribution = LogNormal( mu = 2,  omega = 0.5 ) ),
  ModelParameter( name = "C50",   distribution = LogNormal( mu = 2,   omega = 0.2 ) ) )
