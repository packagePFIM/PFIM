...
evaluationBayFIM_admin1 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
...
evaluationBayFIM_admin2 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
                                      modelEquations = modelEquations,
                                      modelParameters = modelParameters,
                                      modelError =  modelError,
                                      designs = list( design1 ),
...
evaluationBayFIM_admin3 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
                                      modelEquations = modelEquations,
                                      modelParameters = modelParameters,
                                      modelError =  modelError,
                                      designs = list( design1 ),
...
evaluationBayFIM_admin4 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
                                      modelEquations = modelEquations,
                                      modelParameters = modelParameters,
                                      modelError =  modelError,
                                      designs = list( design1 ),
...
evaluationBayFIM_admin4 = run( evaluationBayFIM_admin4 )
...
evaluationBayFIM_admin5 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
                                      modelEquations = modelEquations,
                                      modelParameters = modelParameters,
                                      modelError =  modelError,
                                      designs = list( design1 ),
...
evaluationBayFIM_admin5 = run( evaluationBayFIM_admin5 )
...
evaluationBayFIM_admin6 = Evaluation( name = "PKPD_ODE_multi_doses_compartment_Clozapine",
                                      modelEquations = modelEquations,
                                      modelParameters = modelParameters,
                                      modelError =  modelError,
                                      designs = list( design1 ),
...
evaluationBayFIM_admin6 = run( evaluationBayFIM_admin6 )
...
outputFile = "BayFIM_admin4.html"
outputFileRDS = "popFIM_admin4.rds"
saveRDS(evaluationBayFIM_admin4, file = file.path(outputPath, outputFileRDS))
Report( evaluationBayFIM_admin4, outputPath, outputFile, plotOptions )

outputFile = "BayFIM_admin5.html"
outputFileRDS = "popFIM_admin5.rds"
saveRDS(evaluationBayFIM_admin5, file = file.path(outputPath, outputFileRDS))
Report( evaluationBayFIM_admin5, outputPath, outputFile, plotOptions )

outputFile = "BayFIM_admin6.html"
outputFileRDS = "popFIM_admin6.rds"
saveRDS(evaluationBayFIM_admin6, file = file.path(outputPath, outputFileRDS))
Report( evaluationBayFIM_admin6, outputPath, outputFile, plotOptions )
