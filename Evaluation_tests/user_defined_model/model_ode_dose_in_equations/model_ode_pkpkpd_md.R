...
modelEquations = list( "Deriv_C1" = "(dose_RespPK1 * ka * exp(-(ka * t)) - Cl * C1)/V",
                  ...
                  "Deriv_C3" = "(Rin * (1 - (C2)/(C1 + C50)) - kout * C3)" )
...
administrationRespPK2 = Administration( outcome = "RespPK2", timeDose = c( 0, 50, 100 ), dose = c( 20, 30, 50 ) )
...
arm1 = Arm( name = "BrasTest1",
            ...
            initialConditions = list( "C1" = 0, "C2" = 0, "C3" = "Rin/kout" ) )
...
evaluationPopFIM = Evaluation( name = "evaluation",
                         ...
                         fimType = "population",
                         outputs = list( "RespPK1" = "C1", "RespPK2" = "C2",  "RespPD" = "C3" ),
...
outputPath = file.path("model_ode_pkpkpd_md_results")
