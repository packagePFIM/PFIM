...
The `Model` class represents and stores all information required to
define a structural model (PK, PD, or PKPD). This includes model
parameters, differential equations (ODEs), and the residual error model.
