...
The class `ModelAnalyticInfusionSteadyState` is used to defined an
analytic model in infusion steady state.
...
- functionArgumentsModelAnalyticInfusion:
  ...
  A list giving the functionArguments of the wrapper for the analytic
  model in infusion.

- functionArgumentsSymbolModelAnalyticInfusion:

  A list giving the functionArgumentsSymbol of the wrapper for the
  analytic model in infusion.
